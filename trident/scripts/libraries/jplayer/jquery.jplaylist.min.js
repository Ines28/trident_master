...
"'>&times;</a>";if(a.free){var e=!0;d+="<span class='"+this.options.playlistOptions.freeGroupClass+"'>(";b.each(a,function(a,f){b.jPlayer.prototype.format[a]&&(e?e=!1:d+=" | ",d+="<a class='"+c.options.playlistOptions.freeItemClass+"' href='"+f+"' tabindex='1'>"+a+"</a>")});d+=")</span>"}d+="<a href='javascript:;' class='"+this.options.playlistOptions.itemClass+"' tabindex='1'><span class='title'>"+a.title+"</span>"+(a.artist?" <span class='jp-artist'>por "+a.artist+"</span>":"")+"</a>";d+="<span class='votes'>"+a.votes+" votos</span>"+(a.votable?" <a href='index.php?option=com_content&task=blogcategory&id=3&Itemid=39&action=vote&artist="+a.artist_id+"' class='vote'																																																																																																																																			>votar</a>":"")+"</div></li>";return d},_createItemHandlers:function(){var a=
